/*  Write a C program that reads a series of integers from the user and calculates their sum. 
...
/*SYNTAX OF WHILE LOOP OR ENTRY-CONTROLLED LOOP OR PRE-TESTED LOOP
